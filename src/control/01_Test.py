...
class A_Circle_Arm():
    def __init__(self, arm_ip):
        self.arm = XArmAP#!/usr/bin/env python3
# Software License Agreement (BSD License)
#
# Copyright (c) 2019, UFACTORY, Inc.
# All rights reserved.
...
class A_Circle_Arm():
    def __init__(self, arm_ip):
        ...
        self.poses = [[-292.814117, -127.788345, 210.566269, 122.390603, -90.000000, -38.036663],  # 0
                      ...
                      [-62.316746, -302.001495, 413.709412, 59.536675, 51.647963, -1.001989],     # 46
                      [-216.833588, -226.44252, 421.779755, 56.637508, -52.485684, -31.640105]]
