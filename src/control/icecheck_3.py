...
class A_Circle_Arm():
    def __init__(self, arm_ip):
        ...
        self.frame_queue = queue.Queue(maxsize=1)  # 큐 크기는 1로 설정하여 하나의 프레임만 유지
        ...
        self.cap = cv2.VideoCapture(0)  # 여기서 카메라를 초기화
        self.mp_hands = mp.solutions.hands # Mediapipe Hands 초기화
        ...
        """
        self.angles = {"ice_to_front_press": [-7.9, -0.1, 84.1, -90.6, -96.3, 84.2],  # 각 angle 값 대입
