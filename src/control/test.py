...
class A_Circle_Arm():
    def __init__(self, arm_ip):
        ...
        self.poses = [[-303.092712, -121.410614, 198.670761, -92.245346, -90.000000, -177.668826],  # 0
                      ...
                      [156.644592, -94.609383, 153.885483, -98.206628, -90.000000, -153.788805],    # 6
                      ...
                      [-206.165802, 149.329803, 345.970917, -101.214713, 90.000000, 44.894566],    # 11
                      [-121.567757, 149.914078, 345.926971, -66.56469, 90.000000, -20.461813],     # 12
                      [-16.239532, 149.714157, 345.908478, -103.106907, 90.000000, 6.292853],      # 13
        ...
        self.routes = {"default_to_ice_1": [17, 0],
                       ...
                       "under_press_to_person": [7, 13, 11, 14, 16], # 14는 디폴트 정해서수정필요
